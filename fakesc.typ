#set text(size: 11pt)
#set document(author: ("Test Suite", "fakesc.typ"))
...
#grid(
  columns: 2,
  gutter: 20pt,
  [*Typographic (font features)*], [*Synthetic (forced)*],
  [#smallcaps(typographic: true)[Hello World]], [#smallcaps(typographic: false)[Hello World]],
)
